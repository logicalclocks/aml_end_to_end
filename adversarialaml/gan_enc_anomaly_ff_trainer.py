        ...
        def step_fn(real_data):
            ...
            for i in range(self.d_steps):
                ...
                grad_utils.minimize_using_explicit_allreduce(
                    ...
                    allreduce_bytes_per_pack=self.discriminator_bytes_per_pack)
            ...
            grad_utils.minimize_using_explicit_allreduce(
                ...
                pre_allreduce_callbacks=None,
                post_allreduce_callbacks=None,
                allreduce_bytes_per_pack=self.generator_bytes_per_pack)
            ...
            grad_utils.minimize_using_explicit_allreduce(
                ...
                pre_allreduce_callbacks=None,
                post_allreduce_callbacks=None,
                allreduce_bytes_per_pack=self.encoder_bytes_per_pack)
